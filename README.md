...
Navigate to *New Item*, select *Freestyle project*, and give it the name `choir-deploy`. Subsequently, under *Build* -> *Add build step* choose `Execute shell`. Paste the following shell script into the *Command* field.
